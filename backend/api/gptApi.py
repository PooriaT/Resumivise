            ...
            messages=[
                ...
                },
                {
                    ...
                    "content": f"""I provide you all information from the resume in JSON format as well as the job description.
                        ...
                        skills, Professional experience, projects, and certifications. Then only return in JSON format of result.
                        The format has to be same as what I provided for you in the extracted data from the main version 
                        of resume. Here is the updated JSON format of the revised resume:\n\n The resume infomration is as follows in JSON format: 
                        \n\n {extracted_resume_data}. \n\n You can find job descirpiton here: \n\n {job_description_data} \n\n
                        The output MUST only be in JSON format."""
                }
            ],
            model="gpt-3.5-turbo-16k",
            #stream=True, # Enable streaming. PAY ATTENTION TO THE RETURN VALUE
